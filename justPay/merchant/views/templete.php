...
<head>
	...
	<title>LPG-MERCHANT</title>

	<!-- Global stylesheets -->
	<link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">
	<link href="views/global_assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css">
	...
	<script src="views/global_assets/js/plugins/ui/ripple.min.js"></script>
	<!-- /core JS files -->
	...
	<script src="views/global_assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	...
	<script src="views/global_assets/js/demo_pages/dashboard.js"></script>
	<!-- /theme JS files -->
...
<body>
	...
	<?php
		...
		include ("modules/Main navbar.php");
		include ("modules/Page header.php");
		include ("modules/Page content.php");
		include ("modules/Footer.php");
	?>
	
	<script type="text/javascript" src="views/assets/js/my_ajax.js"></script>
